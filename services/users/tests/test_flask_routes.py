...
class TestUserFlaskRoutes(unittest.TestCase):
    """
    ...
    def test_get_client_users_success(self):
        """Debe retornar 200 y los usuarios si el caso de uso devuelve datos."""
    ...
    def test_get_client_users_not_found(self):
        """Debe retornar 404 si no hay usuarios con rol CLIENT."""
    ...
    def test_get_client_users_internal_server_error(self):
