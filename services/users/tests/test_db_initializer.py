...
class TestDBInitializer(unittest.TestCase):
    """
    Pruebas unitarias para la inicialización de la base de datos en el servicio users.
    """
    ...
    def test_initialize_database_skipped_by_config(self):
        ...
        with patch('users.src.infrastructure.persistence.db_connector.get_connection') as mock_get_conn:
