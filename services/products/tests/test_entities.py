...
# Añade el directorio padre de 'tests/' (que es 'products/') al sys.path.
# Esto permite que 'src' se encuentre como un módulo de primer nivel.
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))
# =========================================================================

# Importamos las entidades del archivo de destino
# Ahora, esta importación debería funcionar:
